...
class MalAnimeDetailsRender(
   ...
   override fun Compose(
      ...
      with(media) {
         ...
         val textAutoSize = TitleStyle.fontSize.stepBased(0.7)
         ...
         SwipeUpToRefresh(
            ...
            Column(
               ...
               TitleCard(
                  ...
                  alternativeTitleTextAutoSize = (TitleStyle.fontSize * 0.7).stepBased(0.7),
                  debug = debug
               ) {
                  ...
                  Column(
                     ...
                     Row(
                        ...
                        Row(
                           ...
                           if (edits.status == MyList.Status.Unknown)
                              Button(
                                 onClick = {
                                    edits = edits.copy(
                                 ...
                                 Text(
                                    ...
                                    style = TitleStyle.copy(
                                       color = cs.onPrimary,
                                       lineHeight = (TitleStyle.lineHeight.value / TitleStyle.fontSize.value).em
                                    ),
                                    autoSize = TitleStyle.fontSize.stepBased(0.5),
                                    maxLines = 1
                                 )
                              }
                           else {
                        ...
                        Row(
                           ...
                           key(updatingStatus.status) {
                              OutlinedButton(
                                 ...
                                 if (callbacks.updatingStatus.status != Resource.Status.Loading) {
                                    Row(
                                       verticalAlignment = Alignment.CenterVertically,
                                    ) {
                                       Icon(
               ...
               relatedAnime.forEach { (key, value) ->
                  ...
                  RelatedMediaCard(
                     ...
                     it.Compose {
                        onNavigation(Screen.Details(it.media.id, it.media.host))
                     }
                  }
                  Spacer(Modifier.height(externalPadding))
               }
